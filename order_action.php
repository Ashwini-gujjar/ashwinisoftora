...
include "user.php";
  ...
  $sql1 = "UPDATE users SET name='".$u_name."', phone='".$u_phone."', address='".$u_address."' WHERE id = '".$u_id."'";
  ...
  $order_id = "LALHT" . strval(mt_rand(100000, 999999));
...
while($row3 = $result3->fetch_assoc()) {
      ...
      $sql2 = "INSERT INTO orders (order_id, user_id, food_id, food_quantity, user_name, user_phone, user_address, timestamp) VALUES ('$order_id', '$u_id', '$f_id', '$f_quantity', '$u_name', '$u_phone', '$u_address', '$timest')";
  ...
  <div class="row order">
    ...
    <div class="col-1">
      <span class="orderedfood">Rs.<?php echo $row3["food_amount"]; ?></span><br />
    </div>
  </div>
